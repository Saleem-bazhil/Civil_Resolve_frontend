...
interface OfficerIssueCardProps {
    searchQuery?: string;
}

const OfficerIssueCard: React.FC<OfficerIssueCardProps> = ({ searchQuery = "" }) => {
    ...
    if (filteredIssues.length === 0) {
        return <Text className="text-gray-500 text-center mt-4">No assigned issues found</Text>;
    }
...
export default OfficerIssueCard;
